...
#include "workshop/x_ray_tube_x/x_ray_tube.h"
...
TEST_F(ServerClientTest, Workshop)
{
	_dispatcher.add<XRayTube::setTubeVoltage>("setTubeVoltage");
	_dispatcher.add<XRayTube::setTubeCurrent>("setTubeCurrent");
	_dispatcher.add<XRayTube::getStatus>("getStatus");
	_dispatcher.add<XRayTube::takePicture>("takePicture"); 
